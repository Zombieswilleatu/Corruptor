> **2026-09-21 combined checkpoint and V27 reserve recipes:** [Lord balance screen](U13_LORD_BALANCE_SCREEN_2026-09-21.md) records the audited combined staging/balance/performance payload on the existing branch, makes both recipe planners count reserved limited monsters, fixes invalid-plan test reporting, and provides a frozen-source, resumable 81-game Lord screen. This prepares local balance evidence; it does not claim new win-rate results.

> **2026-09-21 playable opponent updated to V26:** [Shared CommonSmartCore integration](U13_PLAYABLE_COMMON_SMART_CORE_2026-09-21.md) connects the playable opponent and its economy choices to the existing Python V26 planner through public observations and native legality checks. All 31 observation/decision contracts match exactly; 341 native contract assertions, 17 playable-session assertions, 36 smoke assertions and 36 focused Python tests pass. Failed bot transitions preserve the current turn. The launcher verifies Godot and Python and reports the active policy. This desktop development checkout requires installed Python; standalone packaging and Windows 4.7.2 rendered acceptance remain separate. No rules, weights, long campaign or strength claim.

> **2026-09-21 integration audit at V26:** [Nine-Lord checks and playable planner gap](U13_INTEGRATION_AUDIT_2026-09-21.md) identifies the playable opponent as native Basic Doctrine V8; the recent CommonSmartCore V26 work remains Python-only. The audit corrects the stale declared-rule fingerprint, empty-opening-hand Guard fixtures, the playable visual-retirement expectation and outdated setup help. 57 focused Python tests and 141 native directed assertions pass. Nine four-round Python smoke games cover both seats for every Lord, with 72 decisions / 921 operations and no invalid actions, rejected previews or budget overruns. All nine explicit-input native replays pass 1,003 exact comparisons, including 36 round-end snapshots. This verifies the sampled rule resolution, not native/Python planner equivalence. Next: native planner integration with shared decision fixtures, before more heuristic tuning. No balance or win-rate claim.

> **2026-09-21 Odradek field doctrine V26:** [Valued captures and positional Redirect](U13_ODRADEK_FIELD_DOCTRINE_2026-09-21.md) replaces flat body counts with current health/Armor/ability value and bounded lane-pressure estimates. Own recruitment, spent Supplicants, limited-monster ownership and authoritative Redirect-before-Shift order affect complete plans. Saving uses the same Shift values; existing delayed Guard doctrine is preserved. 61 focused tests and two four-round smoke games pass, with no rule changes, long campaign or strength claim.

> **2026-09-21 Kalligan doctrine V25:** [Useful fire and pulse timing](U13_KALLIGAN_DOCTRINE_2026-09-21.md) values capped Armor/HP damage, kills, remaining fire stages, future occupancy and known Forge repair. Pyroclasm compares its incremental lane benefit against the automatic pulse and can wait for the stronger stage. Same-plan recruits, monsters and departing Supplicants affect placements and pulses. 70 focused tests and two four-round smoke games pass; two stale replay pins are reviewed against unchanged parent `6ea2114`. One changed natural pulse choice buys 19 enemy HP damage for 10 friendly HP damage in a controlled continuation. Game rules are unchanged; no strength claim or long campaign.

> **2026-09-21 Kroni doctrine V24:** [Meals, erratic routes and proportional artwork](U13_KRONI_DOCTRINE_2026-09-21.md) enforces opposite-attack-lane Consume, pair-first targeting, and bounded Ravenous timing across both armies and planned recruits. Available group routes always receive a varied weighted launch; random fallback remains when none qualify. Atlas proportions survive widened lanes. 45 Python tests, 953 native assertions, 89 launch/geometry checks, 16 native/Python parity cases, 54 headless board compatibility checks and two four-round smoke games pass. The pre-existing inactive-Breach fixture is corrected without changing immunity rules. No long balance run or strength claim.

> **2026-09-20 Defense fixture failures closed:** [Reviewed saved-state expectations](U13_DEFENSE_FIXTURE_REFRESH_2026-09-20.md) refreshes the two early-defense fingerprints after comparing historical and current replays. Previous hashes are retained. Original inputs and all defense assertions remain intact; all 9 defense tests pass. The current bot preserves the two Keeps at 1 and 3 Integrity. No game-rule or doctrine changes.

> **2026-09-20 Valak doctrine V23:** [Tactical gravity wells and paid friendly sacrifice](U13_VALAK_DOCTRINE_2026-09-20.md) replaces cluster counts with two-round pull, support, delay and friendly-exposure estimates. Projection keeps useful reserves and values retained-card follow-up. A paid own-Guard Projection kill now grants +2 Essence (cap five); the bot requires a useful net gain and accounts for pair/defense loss. Focused Python checks, 242 native checks and two four-round smoke games pass. Two historical defense-view hash failures reproduce on the unchanged parent. No long balance run or strength claim. Next Lord doctrine: Kroni.

> **2026-09-20 Gravity well:** [Valak pull, slow damage and open Projection](U13_GRAVITY_WELL_2026-09-20.md) changes Orb into additive weak pull, a tiny lethal core and five-second outer damage pulses. Both guard-zone owners are legal for Projection. Focused native/Python parity covers 800 ticks; board interaction passes in explicit compatibility mode. No long balance campaign.

> **2026-09-20 Orias doctrine V16:** [Useful Web control and Snare preparation](U13_ORIAS_CONTROL_DOCTRINE_2026-09-20.md) evaluates both Web phases, prospective firing coverage and arrivals, and next-round Hunt/Siege opportunities using retained cards before paying for Snare. Existing Guards remain in the forecast. CPython and PyPy each pass 51 focused methods; four directed decisions match exactly. The 32-plan / eight-preview limits and game rules are unchanged; no balance matches ran. Next: Gremory's delayed Ruin, then Kanifous Wish/Price.

> **2026-09-20 Rout doctrine V15:** [Retreat attacks and emergency delay](U13_ROUT_PUNISH_DOCTRINE_2026-09-20.md) replaces distant head counts with bounded attack-window estimates, including immediate attacks by same-plan recruits. Gate/overrun delay remains available. CPython and PyPy each pass 38 focused checks; 32 plans / eight previews, full retreat speed and loadout rules remain unchanged. The balance comparison stays stopped.

> **2026-09-20 Rout rules change:** [Fleeing-only attack bonus](U13_ROUT_FLEEING_DAMAGE_2026-09-20.md) adds +1 damage from regular attacks during retreat; half-speed recovery takes normal damage. Local native/Python correctness and 38 exact packet replays pass. The old/new/none comparison was stopped at the user's request; production doctrine remains V12.

> **2026-09-19 Rout answer experiment — retain V12:** [Measured candidate and combined-engine review](U13_ROUT_ANSWER_2026-09-19.md) records V13 **19–15** before the parallel monster-control fixes, then **15–19** on the combined engine at `bcf1fad` (34 games / 644 rounds / 16,240 operations; zero failures or rejected previews). The new cohort gains no non-mirror setup and loses one; V12 wins both mirrors in both cohorts. Candidate code remains in Git; `2b99c7f` restores V12 and preserves two reviewed observation histories plus the Castle-lane expectation. Earlier controlled results keep their original engine scope. Local CPython and PyPy each pass **168 tests and five games / 85 rounds / 2,144 operations**, with identical reports and input files; Windows acceptance remains pending.
