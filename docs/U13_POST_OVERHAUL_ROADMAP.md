> **2026-09-17 opening adopted:** The user accepted the [normal-draw/free-Lord opening](U13_FREE_OPENING_2026-09-17.md). Godot and PySim now use it for new matches, retaining the tested deck sequence. Local diagnostic checks match nine exact openings; Windows 4.7.2 / PyPy acceptance remains pending. Next doctrine sequence: bounded Invocation plans, power/plan conflicts, then Odradek's resource horizon. Reassess opening defense under the adopted rules before tuning it.
