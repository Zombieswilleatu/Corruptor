...
The reproducible experimental checkpoint is `2099326` (tree
`f7b629d92479e8953639c9299520b556ae816375`; tested local alias `235cb6c`).
The later parallel navigation update at `176e175` changes the engine. The Rout
outcomes below precede that update; a subsequent compatibility check does not
re-measure these interventions on the newer rules. The [navigation integration](U13_DOCTRINE_NAVIGATION_REPLAY_2026-09-19.md) records that separate gate.
...
collection at checkpoint `2099326`; `--resume` can reuse matching complete continuations. The archive
