> **2026-09-18 current doctrine checkpoint:** The Python planner has progressed through Rite reachability, closing choices, power/plan coordination and Odradek resource saving; [V7 passed the Windows dual-runtime gate](../docs/U13_ODRADEK_HORIZON_2026-09-18.md). [V8 Guard placement and Work](../docs/U13_EARLY_DEFENSE_2026-09-18.md) now passes 129 local tests and five complete games. Its separate 162-game comparison finished 81–81 with zero failures/rejected previews; early castle destruction events fell from 78 to 31 across 81 matched openings. Next: accept V8 on Windows CPython/PyPy, then inspect remaining Lord-specific tactical gaps. This supersedes the immediate doctrine sequence in the older planning baseline below. Expanded native decision parity and balance work remain later gates; greedy remains the default.
