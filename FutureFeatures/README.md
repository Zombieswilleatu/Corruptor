...
| Python mirror | Foundation through ordinary resolution retains its dated Windows acceptance. The four-Lord [ordinary full-match gate](../docs/U13_PYSIM_FULL_MATCH_2026-09-15.md) passed at `d059b95`; [paid Development](../docs/U13_PYSIM_PAID_DEVELOPMENT_2026-09-16.md) passed at `24792a6`: four exact games / 57 rounds, 77 tests per Python runtime and 20 corruption rejections. The new [nine-Lord adapter](../docs/U13_PYSIM_NINE_LORDS_2026-09-16.md) implements all 23 powers and remaining Lord lifecycles. Five complete local diagnostic games cover the roster; separately labeled components cover each power and spatial actors. Windows 4.7.2 / CPython / PyPy acceptance is pending. |
