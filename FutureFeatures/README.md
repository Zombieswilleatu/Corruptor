> **2026-09-20 Gremory Ruin V19:** [Delayed damage and competing card commitments](../docs/U13_GREMORY_RUIN_2026-09-20.md) forecasts own artillery and Hunt/Siege before next-round Ruin, preserves recipe ingredients and adds bounded alternatives using uncommitted cards. Eighty focused PyPy methods and eleven new CPython methods pass. On 49 saved boards, Ruin selections rise from 9 to 21 while all 49 recipe orders are preserved; no win-rate claim. Two older Deimos replay-view hash failures reproduce exactly on unchanged V18 and remain separate. Orias V18 and game rules are unchanged. Next: Kanifous Wish/Price.

> **2026-09-20 Orias Snare V18:** [Threat-aware Snare aggression](../docs/U13_ORIAS_SNARE_THREAT_2026-09-20.md) permits opportunistic setups at resulting Threat two or less, compares attacks with Guard/Ward and recipe alternatives above two, and charges for Summoning Circle absorption and loss of operation. Web remains V17. Sixty-one focused tests pass. All sixteen matched games completed: V17 and V18 each win 5/8 with identical paired outcomes; attack follow-through is 3/14 versus 4/13 Snares. Every cast resulted in Threat one, so high-Threat selectivity is supported by directed tests only. Keep as the requested risk-aware experiment, without claiming a strength gain.
