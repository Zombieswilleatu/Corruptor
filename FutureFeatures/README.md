...
1. Finish Windows acceptance of the first two independent setup-to-victory references and measure their actual cost. The new four-Lord path includes cleanup and victory, with no fixture state inserted between rounds. Keep that reference while addressing the measured bottleneck.
