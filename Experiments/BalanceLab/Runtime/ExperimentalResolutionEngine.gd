class_name ExperimentalResolutionEngine
extends RefCounted
...
const HuntResolutionEngineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalHuntResolutionEngine.gd"
)

const SiegeResolutionEngineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalSiegeResolutionEngine.gd"
)

const ProfaneResolutionEngineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalProfaneResolutionEngine.gd"
)
...
const ReflexActionEngineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalReflexActionEngine.gd"
)
