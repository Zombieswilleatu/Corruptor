class_name ExperimentalBotDoctrine
extends RefCounted


const GameSetupData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalGameSetup.gd"
)
...
static func evaluate_bid_candidates(
	...
	assert(game != null, "Experimental deprecated Reflex evaluator requires a GameState.")
	assert(rules != null, "Experimental deprecated Reflex evaluator requires RuleConfig.")
...
static func bid_choices(
	...
	assert(game != null, "Experimental deprecated Reflex Bid doctrine requires a GameState.")
	assert(rules != null, "Experimental deprecated Reflex Bid doctrine requires RuleConfig.")
	var decisions: Dictionary = {}
...
static func evaluate_action_candidates(
	...
	var forced_action: String = String(
		game.get_meta(
