class_name ExperimentalBotRoundEngine
extends RefCounted
...
const SummonEngineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalSummonEngine.gd"
)
...
const RevealEngineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalRevealEngine.gd"
)

const ResolutionEngineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalResolutionEngine.gd"
)

const BotDoctrineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalBotDoctrine.gd"
)
...
const BotDevelopmentDoctrineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalBotDevelopmentDoctrine.gd"
)

const BotDominionRiteDoctrineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalBotDominionRiteDoctrine.gd"
)

const BotDeployDoctrineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalBotDeployDoctrine.gd"
)

const BotResolutionDoctrineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalBotResolutionDoctrine.gd"
)
