class_name ExperimentalGameSetup
extends RefCounted
...
const LORD_CONTENT: Dictionary = {
	...
	# Structural test Lord. It exists only in the disposable Balance Lab
	# runtime and deliberately has no name-triggered abilities.
	"Vanilla": {
		"summon_cost": 6,
		"base_defense": 5,
		"return_threat": 1,
