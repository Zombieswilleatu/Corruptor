class_name ExperimentalBotResolutionDoctrine
extends RefCounted
...
const BotReflexDoctrineData = preload(
	"res://Experiments/BalanceLab/Runtime/ExperimentalBotReflexDoctrine.gd"
)
...
static func build_decisions(
	...
	decisions["gremory_provider"] = Callable(
		load("res://Experiments/BalanceLab/Runtime/ExperimentalBotResolutionDoctrine.gd"),
