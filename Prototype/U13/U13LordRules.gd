...
const RULES: Dictionary = {
	"Kanifous": {"passive": "THE WISHMASTER\nSmoke marks a region one round before a Lamp appears. First Marcher of either side to touch it receives a suit-specific Wish, with a 10% chance of destruction instead.\n\nWISH\nChoose one Wish per round: Power spawns 3 random Marchers; Longevity fully restores a Castle; Resurrection restores this round’s defeated Guards in one zone; Death destroys all Marchers in a circle; Wealth draws 2 cards.\n\nTHE PRICE\nSuccessful Wishes create hidden Prices due 1–3 rounds later. Due rounds are public. Prices may discard cards, destroy your Marchers, defeat a Guard, damage or disable a Castle, cost a Soul, or rarely banish Kanifous. Stone, Soul, Ruin and banishment each add a Neutral Tear.", "breach": "THE VOID\nThe board loses visual precision while Kanifous occupies the Breach. Rules and authoritative state remain exact."},
	"Valak": {
