...
const RULES: Dictionary = {
	"Kanifous": {"passive": "THE WISHMASTER\nSmoke marks a region one round before a Lamp appears. Marchers within 180 field units steer toward a Lamp in their lane. First Marcher of either side to touch it receives a suit-specific Wish, with a 10% chance of destruction instead.\n\nWISH\nChoose one Wish per round: Power spawns 1–3 random Marchers (25% one, 50% two, 25% three); Longevity repairs an active Castle up to 8 Integrity, capped at its maximum; cannot target Castles already at or above that (never protected construction); Resurrection revives your Marchers killed this round in a chosen battlefield lane after Marching, at full HP and Armor near where they fell; Death destroys all Marchers in a small circle; Wealth draws 1–3 cards (20% one, 50% two, 30% three).\n\nTHE PRICE\nSuccessful Wishes create hidden Prices due 1–3 rounds later. Due rounds are public. If nothing can be collected, the debt remains and retries each round. Prices may discard cards, destroy your Marchers, defeat a Guard, damage or disable a Castle, cost a Soul, or rarely banish Kanifous. Stone, Soul, Ruin and banishment each add a Neutral Tear.", "breach": "THE UNBOUND WISHMASTER\nBoth players may take one optional Breach Wish per round using ordinary Wish effects.\n\nBREACH WISH — HEAVIER PRICE\nSuccess creates a Price due in 1–3 rounds. Stone, Soul, Ruin and Lord banishment have double their ordinary draw weight; ineligible outcomes are excluded. Each adds a Neutral Tear. A protected player denies the opponent Breach Wish access. Ordinary Wishes keep their usual Prices."},
	"Valak": {
