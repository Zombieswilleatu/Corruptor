...
const PREVIEWS: Array = [
	{"title": "Sprites · Subjects & Monsters", "note": "Cycle all characters; compare still-frame Godot motion and sprite sheets, including Sooge’s permanent turret form.", "scene": "res://Prototype/U13/U13SoogeLanePreview.tscn", "size": Vector2(1280, 900)},
