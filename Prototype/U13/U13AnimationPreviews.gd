...
const PREVIEWS: Array = [
	{"title": "Sprites · Subjects & Monsters", "note": "Cycle characters; compare Penitent still motion and sprite sheets, including Sooge’s permanent turret form.", "scene": "res://Prototype/U13/U13SoogeLanePreview.tscn", "size": Vector2(1280, 900)},
