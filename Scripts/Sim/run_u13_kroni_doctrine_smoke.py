#!/usr/bin/env python3
"""Two four-round Kroni smoke games. Legality/performance check, not win evidence."""
import json
import time
...
def main():
    ...
    for lords in (['Kroni', 'Valak'], ['Orias', 'Kroni']):
        setup = dict(full_match_inputs.load()['cases'][0]['setup'], lords=lords, seed='kroni-v24-smoke:'+':'.join(lords))
