...
if [[ ${2:-} == --game ]]; then
  u13_runners=(U13GameEconomy U13GameConductor U13GameRandom)
  u13_markers=('U13 game economy failures: 0' 'U13 game conductor failures: 0' 'U13 game random failures: 0')
fi
if [[ ${2:-} == --kanifous ]]; then
