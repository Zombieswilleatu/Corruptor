...
if [[ ${2:-} == --game ]]; then
  u13_runners=(U13GameEconomy U13GameConductor U13GameRandom U13GameDevelopment U13GamePlanCoverage U13CastleDefenses U13Stockpile)
  u13_markers=('U13 game economy failures: 0' 'U13 game conductor failures: 0' 'U13 game random failures: 0' 'U13 game development failures: 0' 'U13 game plan coverage failures: 0' 'U13 castle defenses failures: 0' 'U13 Stockpile failures: 0')
fi
if [[ ${2:-} == --kanifous ]]; then
