...
if [[ ${2:-} == --game ]]; then
  u13_runners=(U13GameEconomy U13OpeningEconomy U13Fracture U13DominionRites U13VacantThrone U13VultureRanged U13Plunder U13Victory U13GameConductor U13GameRandom U13GameDevelopment U13GamePlanCoverage U13CastleDefenses U13Stockpile U13GameMarket U13BloodConduit U13Sigils U13SigilBoard)
  u13_markers=('U13 game economy failures: 0' 'U13 opening economy failures: 0' 'U13 Fracture failures: 0' 'U13 Dominion rites failures: 0' 'U13 Vacant Throne failures: 0' 'U13 Vulture ranged failures: 0' 'U13 Profane Pillage failures: 0' 'U13 victory failures: 0' 'U13 game conductor failures: 0' 'U13 game random failures: 0' 'U13 game development failures: 0' 'U13 game plan coverage failures: 0' 'U13 castle defenses failures: 0' 'U13 Stockpile failures: 0' 'U13 game market failures: 0' 'U13 Blood Conduit failures: 0' 'U13 Sigils failures: 0' 'U13 Sigil board failures: 0')
fi
if [[ ${2:-} == --kanifous ]]; then
