#!/usr/bin/env python3
"""Two four-round Valak smoke games. Legality/performance check, not win evidence."""
import json
import time
...
def main():
    ...
    for lords in (['Valak', 'Kroni'], ['Orias', 'Valak']):
        setup = dict(full_match_inputs.load()['cases'][0]['setup'], lords=lords, seed='valak-v23-smoke:'+':'.join(lords))
