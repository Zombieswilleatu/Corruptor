...
VERSION = 'U13_POWER_COORDINATION_V8_KANIFOUS'
TERMS = frozenset(('Projection', 'Consume', 'Ravenous', 'Redirect', 'FalseOrders', 'AllegianceShift', 'Inversion', 'Pyroclasm', 'BreathOfLife', 'Rout', 'Web', 'Snare', 'InevitableRuin'))
