...
ROSTER = {'Lemek': {'tier': 'Easy',
 ...
 'Varn': {'tier': 'Easy',
          ...
          'speed': 2,
          'hp': 2,
          'ability': 'Summons 3–5 bodies. Each damaging hit has a 10% chance to poison: 1 HP at the start of '
                     'each of the next two Marching phases. Refreshes; does not stack.'},
 'Fyra': {'tier': 'Moderate',
          ...
          'speed': 4,
          'hp': 5,
          'ability': 'Flies over ground hazards. Each hit has a 15% chance to charm its target for the rest '
                     'of this round. Ownership returns before the next round.'},
 ...
 'Tumler': {'tier': 'Moderate',
            ...
            'speed': 3,
            'hp': 5,
            'ability': 'Pursues a chosen enemy, preferring ordinary Vultures and support monsters. Tries to '
                       'skirt other enemies and slowing pools; can be intercepted.'},
 'Kurchin': {'tier': 'Hard',
 ...
 'Sinodek': {'tier': 'Very hard',
             ...
             'speed': 1,
             'hp': 5,
             'ability': '25% chance each active round to open a portal ahead for that Marching phase. Nearby '
                        'units flee; entering units are banished, without death triggers or resurrection. '
