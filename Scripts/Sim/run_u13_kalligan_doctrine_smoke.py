#!/usr/bin/env python3
"""Two four-round Kalligan smoke games. Legality/performance check, not win evidence."""
import json
import time
...
def main():
    ...
    for lords in (['Kalligan', 'Valak'], ['Kroni', 'Kalligan']):
        setup = dict(full_match_inputs.load()['cases'][0]['setup'], lords=lords, seed='kalligan-v25-smoke:'+':'.join(lords))
