...
const ODRADEK_PROFILE: String = "U13_ODRADEK_COMPLETE_V2"
const ORIAS_WEB_PROFILE: String = "U13_ORIAS_MARK_BOARD_V4"
const HUMBABA_PROFILE: String = "U13_HUMBABA_BREATH_V3_IMMEDIATE_PULSE"
...
static func defense(world: Dictionary, lord: Dictionary) -> int:
	...
	return (
		(
			...
			else (5 if lord.attributes.get("lord_id") in ["Odradek", "Valak", "Kanifous"] else 4)
		)
