...
const ROSTER: Dictionary = {
	...
	"Fyra": {"tier": "Moderate", "recipe": {"Butcher": 2, "Vulture": 2}, "attack": 2, "armor": 1, "speed": 4, "hp": 10, "ability": "Flies over ground hazards. Each hit has a 15% chance to charm its target for the rest of this round. Ownership returns before the next round."},
