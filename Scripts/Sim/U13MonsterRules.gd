...
const VERSION: String = "U13_MONSTERS_V15_DOTRA_EXPOSURE"
...
const ROSTER: Dictionary = {
	...
	"Dotra": {"tier": "Hard", "recipe": {"Butcher": 3, "Vulture": 1}, "attack": 2, "armor": 2, "speed": 2, "hp": 10, "ability": "25% chance to hide each active round. Stalks at full speed while hidden until delivering a 5-damage ambush within 240. On emergence, exposes enemies within 360 for one full round: +1 incoming damage per hit, before Armor. Refreshes but never stacks. Blocks and evasion still prevent damage."},
...
const TUNING: Dictionary = {"tumler_evasion_chance": 50, "tumler_hunt_bonus": 1, "kurchin_deflection_chance": 75, "varn_poison_chance": 10, "fyra_charm_chance": 30, "kopita_radius": 360, "kopita_second_pulse_tick": 133, "taunt_radius": 360, "muno_radius": 480, "dotra_hide_chance": 25, "dotra_ambush_radius": 240, "dotra_expose_radius": 360, "dotra_expose_ticks": 200, "sooge_root_chance": 25, "sooge_root_increase": 15, "beam_range": 1800, "beam_half_width": 70, "beam_interval_ticks": 200, "beam_charge_ticks": 32, "beam_blast_delay_ticks": 8, "sinodek_portal_chance": 25, "portal_target_range": 600, "portal_radius": 100, "portal_fear_radius": 300, "pool_radius": 200}
