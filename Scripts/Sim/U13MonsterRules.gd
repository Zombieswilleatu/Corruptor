...
const VERSION: String = "U13_MONSTERS_V13_RESPONSIVE_SUPPORT"
...
const ROSTER: Dictionary = {
	...
	"Dotra": {"tier": "Hard", "recipe": {"Butcher": 3, "Vulture": 1}, "attack": 2, "armor": 2, "speed": 2, "hp": 10, "ability": "25% chance to hide each active round. Stalks enemies at full speed while hidden and stays hidden until delivering a 5-damage ambush against an enemy within 240. No timed reveal. Hidden units cannot be selected for ordinary attacks."},
