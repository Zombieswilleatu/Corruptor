...
const VERSION: String = "U13_MONSTERS_V12_TARGETED_POWERS"
...
const ROSTER: Dictionary = {
	...
	"Kopita": {"tier": "Moderate", "recipe": {"Wright": 2, "Penitent": 2}, "attack": 2, "armor": 1, "speed": 2, "hp": 10, "ability": "Pulses at the start of each active round, alternating green healing (allies recover 1 HP) and violet harm (enemies take 1 damage). Starts with healing; radius 360. Slows near allied front-line fighters to stay behind them."},
...
const TUNING: Dictionary = {"tumler_evasion_chance": 50, "tumler_hunt_bonus": 1, "kurchin_deflection_chance": 75, "varn_poison_chance": 10, "fyra_charm_chance": 30, "kopita_radius": 360, "taunt_radius": 360, "muno_radius": 480, "dotra_hide_chance": 25, "dotra_ambush_radius": 240, "sooge_root_chance": 25, "sooge_root_increase": 15, "beam_range": 1800, "beam_half_width": 70, "beam_interval_ticks": 200, "beam_charge_ticks": 32, "beam_blast_delay_ticks": 8, "sinodek_portal_chance": 25, "portal_target_range": 600, "portal_radius": 100, "portal_fear_radius": 300, "pool_radius": 200}
